...
const QMetaObject ChildWindow::staticMetaObject = {
    { &QMdiSubWindow::staticMetaObject, qt_meta_stringdata_ChildWindow.data,
      qt_meta_data_ChildWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
